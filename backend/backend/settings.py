...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'backend-production-f7ba.up.railway.app',
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "https://frontend-production-0858.up.railway.app",
]
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [os.getenv('REDIS_URL', f"redis://{os.getenv('REDIS_HOST', '127.0.0.1')}:{os.getenv('REDIS_PORT', 6379)}")],
        },
    },
}
